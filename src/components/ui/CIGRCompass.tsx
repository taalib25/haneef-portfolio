    ...
    <div className="relative w-full max-w-140 mx-auto aspect-square flex items-center justify-center my-16 md:my-24 group px-4">
      ...
      >
        ...
        <g>
          ...
          {/* South - Crimson Dark */}
          <polygon
            points="280,520 286,510 280,500 274,510"
            fill="var(--crimson-dark)"
          />
          {/* West - Navy Light */}
          <polygon
            points="40,280 50,274 60,280 50,286"
            fill="var(--navy-light)"
          />
          {/* East - Crimson */}
          <polygon
            points="520,280 510,274 500,280 510,286"
            fill="var(--crimson)"
          />
        </g>
        ...
        >
          {/* North (C) */}
          <text x="280" y="110" fill="var(--navy)">
            C
          </text>
          {/* East (G) */}
          <text x="440" y="285" fill="var(--crimson)">
            G
          </text>
          {/* South (R) */}
          <text x="280" y="460" fill="var(--crimson-dark)">
            R
          </text>
          {/* West (I) */}
          <text x="120" y="285" fill="var(--navy-light)">
            I
          </text>
        </g>
