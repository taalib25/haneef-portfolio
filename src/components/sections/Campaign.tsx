...
export default function Campaign() {
  ...
  return (
    <section id="campaign" ref={containerRef} className="py-[5rem] md:py-[8rem] px-6 md:px-12 lg:px-20 bg-[var(--bg-campaign)] text-[var(--ct1)]">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="relative mb-20 text-center py-24 md:py-32 px-6 rounded-3xl overflow-hidden border border-[var(--cb)] shadow-sm">
          ...
          <div className="relative z-10">
            <p className="font-mono text-[var(--cta)] text-[0.7rem] tracking-[0.20em] uppercase mb-8">
              [ 04 — THE CAMPAIGN ]
            </p>
            <h2 className="font-display text-[clamp(3.5rem,6vw,6rem)] text-[var(--ct1)] leading-[0.92] tracking-[-0.025em] uppercase mb-6">
              RUNNING FOR<br />
              DISTRICT ROTARACT<br />
              REPRESENTATIVE
            </h2>
            <p className="font-mono text-[0.7rem] text-[var(--cta)] tracking-[0.20em] uppercase mb-16">
        ...
        <div className="max-w-[800px] mx-auto mb-32">
          <h3 className="font-mono text-[0.7rem] text-[var(--cta)] tracking-[0.20em] uppercase mb-8 text-center">
            WHY I AM RUNNING
          </h3>
          <div className="font-body text-[1.125rem] text-[var(--ct2)] leading-[1.75] space-y-6">
            <p>
        ...
        <div className="flex flex-col md:flex-row border-t border-b border-[var(--cb)] mb-32">
          <div className="flex-1 py-12 md:pr-12 border-b md:border-b-0 md:border-r border-[var(--cb)]">
            <h3 className="font-mono text-[0.7rem] text-[var(--cta)] tracking-[0.20em] uppercase mb-6">
              VISION:
            </h3>
            <p className="font-body text-[1.125rem] text-[var(--ct2)] leading-[1.75]">
        ...
        {/* Three Challenges */}
        <div className="mb-32">
          <h3 className="font-mono text-[0.7rem] text-[var(--cta)] tracking-[0.20em] uppercase mb-12 text-center">
          ...
          <div className="flex flex-col gap-16">
            <div className="relative">
              ...
              <p className="font-body text-[1.0625rem] text-[var(--ct2)] leading-[1.75] max-w-[800px]">
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            <h3 className="font-mono text-[0.7rem] text-[var(--cta)] tracking-[0.20em] uppercase mb-4">
              CIGR Strategic Analysis
            </h3>
            <p className="font-body text-[0.9rem] text-[var(--ct2)] italic">
          ...
          <div className="flex flex-col border-t border-[var(--cb)]">
            {[
              ...
              { letter: 'R', title: 'RISKS', body: 'Volunteer fatigue and economic uncertainty are real challenges for a youth-driven organisation. We must build systems that support member wellbeing and ensure our projects remain sustainable — not just ambitions.', color: 'var(--crimson-dark)' }
            ].map((item, i) => (
              <div key={i} className="flex flex-col md:flex-row py-6 border-b border-[var(--cb)]">
                ...
                <div className="flex-1 flex flex-col justify-center">
                  <h4 className="font-mono text-[0.7rem] tracking-[0.20em] uppercase mb-2" style={{ color: item.color }}>
                    {item.title}
                  </h4>
                  <p className="font-body text-[1.0625rem] text-[var(--ct2)] leading-7">
                    {item.body}
                  </p>
                </div>
              </div>
        ...
        <div className="mb-32">
          ...
          <div className="flex flex-col gap-16">
            <div className="relative">
              ...
              <p className="font-body text-[1.0625rem] text-[var(--ct2)] leading-7 max-w-[800px]">
            ...
            {[
              ...
              <div key={i} className="flex flex-col md:flex-row py-6 border-b border-[var(--cb)]">
                <div className="md:w-[300px] flex-shrink-0 mb-2 md:mb-0">
                  <span className="font-mono text-[0.7rem] tracking-[0.20em] uppercase">
                    {val.name}
                  </span>
                </div>
        ...
        <div className="flex justify-center mt-24">
          <a
            href="#contact"
            className="inline-flex justify-center items-center bg-[var(--crimson)] text-[var(--t1)] font-mono text-[var(--t-sm)] uppercase tracking-widest px-8 py-4 hover:bg-[var(--crimson-dark)] transition-colors min-h-[52px] rounded-sm"
          >
            CONTACT ME
          </a>
        </div>
