...
export default function Campaign() {
  ...
  return (
    <section
      id="campaign"
      ref={containerRef}
      className="py-20 md:py-32 px-6 md:px-12 lg:px-20 bg-(--bg-campaign) text-(--ct1)"
    >
      <div className="max-w-300 mx-auto">
        ...
        <div className="relative mb-20 text-center py-24 md:py-32 px-6 rounded-3xl overflow-hidden border border-(--cb) shadow-sm">
          ...
          <div className="relative z-10">
            ...
            <p className="font-body text-(length:--t-2xl) italic text-(--ct2) max-w-170 mx-auto text-center">
        ...
        <div className="mb-32">
          ...
          {/* Replace compass with editorial grid */}
          <CIGRGrid />
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
            <div>
              <h4 className="font-display text-(length:--t-xl) text-(--ct1) mb-4">
                Pillar 1 — Rotaractor Value Chain:
              </h4>
