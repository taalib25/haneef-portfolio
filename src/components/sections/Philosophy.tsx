    ...
    >
      <div className="max-w-300 mx-auto flex flex-col items-center">
        ...
        <div className="w-full mb-20 text-center">
          ...
          <div
            ref={headlineRef}
            className="font-display text-t-philosophy leading-[0.92] tracking-[-0.025em] uppercase mb-12 flex flex-col items-center"
          >
          ...
          <motion.div
            ...
            className="font-body text-[1.25rem] text-(--t2) max-w-150 mx-auto leading-[1.75] text-center"
          >
        ...
        >
          ...
          <div className="flex-1 py-8 md:py-0 md:px-8 md:border-r border-(--border) md:first:pl-0">
            ...
            <p className="font-body text-t-base text-(--t2) leading-[1.8]">
              Leadership must anticipate future opportunities while remaining
              connected to the everyday realities faced by Rotaract clubs and
              members. It cannot afford to be abstract — it must be practical
              and felt at the club level.
            </p>
          </div>
          ...
          <div className="flex-1 py-8 md:py-0 md:px-8 border-t md:border-t-0 md:border-r border-(--border)">
            ...
            <p className="font-body text-t-base text-(--t2) leading-[1.8]">
              The responsibility of district leadership is to enable club
              leaders — by removing obstacles and providing the tools they need
              to succeed. Not to direct from above, but to support from within.
            </p>
          </div>
