export default function Contact() {
  return (
    <section id="contact" className="py-[4.5rem] md:py-[7rem] px-6 md:px-12 lg:px-20 bg-[var(--bg-hero)]">
      <div className="max-w-[1200px] mx-auto">
        {/* Section Header */}
        <div className="mb-20">
          <p className="font-mono text-[var(--hta)] text-[var(--t-xs)] tracking-widest uppercase mb-8">
            [ 06 — CONNECT ]
          </p>
          <h2 className="font-display text-[var(--t-4xl)] text-[var(--ht1)] leading-[0.92] tracking-[-0.025em] uppercase mb-6">
            LET'S TALK.
          </h2>
          <p className="font-body text-[var(--t-lg)] text-[var(--ht2)] max-w-[680px] leading-[1.75]">
        ...
        <div className="flex flex-col md:flex-row border-t border-[var(--crimson-border)] md:border-t-0">
          ...
          <div className="flex-1 py-12 md:pr-12 border-b md:border-b-0 md:border-r border-[var(--crimson-border)] flex flex-col items-start">
            ...
            <h3 className="font-display text-[var(--t-2xl)] text-[var(--ht1)] uppercase mb-4">
              DISTRICT 3220
            </h3>
            <p className="font-body text-[var(--t-sm)] text-[var(--ht2)] mb-12">
              Rotaract conversations, DRR enquiries
            </p>
            <a
              href="mailto:haneef.rotaract3220@gmail.com?subject=District 3220 Enquiry"
              className="inline-flex justify-center items-center bg-[var(--hta)] text-[var(--crimson-dark)] font-mono text-[var(--t-sm)] uppercase tracking-widest px-8 py-4 hover:bg-[var(--cta)] transition-colors min-h-[52px] mt-auto"
            >
              REACH OUT →
            </a>
          </div>
        ...
        <div className="mt-24 text-center flex flex-col items-center gap-4">
          <a
            ...
            className="font-mono text-[var(--t-xs)] text-[var(--ht2)] tracking-widest uppercase hover:text-[var(--ht1)] transition-colors"
          >
            +94 77 044 7021 [CALL]
          </a>
          <a
